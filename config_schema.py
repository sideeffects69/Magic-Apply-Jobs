    ...
    },
    {
        ...
        "fields": [
            ...
            _f("Profile", "questions", "years_of_experience", "Years of experience", "text",
               "What to answer for 'how many years of experience do you have' questions. A number in text, e.g. 0, 1, 3, 5. The pre-filled number is only a sample - set your own."),
            ...
            _f("Profile", "questions", "desired_salary", "Desired salary", "number",
               "Your expected salary or CTC as a plain number (no currency symbols or commas), e.g. 100000. Some forms only accept numbers. The pre-filled number is only a sample - set your own."),
            _f("Profile", "questions", "current_ctc", "Current salary", "number",
               "Your current salary or CTC as a plain number, e.g. 80000. The pre-filled number is only a sample - set your own."),
            _f("Profile", "questions", "notice_period", "Notice period (days)", "number",
               "Your notice period in days, e.g. 0, 15, 30. The tool converts to weeks or months if a form asks that way. The pre-filled number is only a sample - set your own."),
