...
easy_apply_only = False            # True = only LinkedIn Easy Apply jobs. False = every kind of job, including ones that apply on the company's own website, Note: True or False are case-sensitive
