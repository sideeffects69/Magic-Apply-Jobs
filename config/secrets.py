...
# Google account to use for "Sign in / Sign up with Google" buttons on company websites. If your browser is already signed
# in to Google, the tool just picks this account on Google's screen. It never types a Google password: if Google asks
# for one (or 2-step verification), the tool waits for you to finish it in the browser window.
google_email = ""                        # "you@gmail.com" or "" (uses the first account Google shows)
