...
def validate_settings() -> None | ValueError | TypeError:
    ...
    check_boolean(external_apply_enabled, "external_apply_enabled")
    check_boolean(use_google_login, "use_google_login")
    check_int(external_manual_wait_seconds, "external_manual_wait_seconds", 0)
    check_int(external_apply_timeout_seconds, "external_apply_timeout_seconds", 30)
    check_int(external_apply_max_steps, "external_apply_max_steps", 3)
